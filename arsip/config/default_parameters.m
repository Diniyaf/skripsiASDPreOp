...
params.epsilon_asd = 0.1; % Numerical smoothing width for ASD orifice law [mmHg]

params.asd.mode        = 'linear_bidirectional'; % ASD model option [-]
params.asd.area_mm2    = 0.0;   % Septal defect area [mm^2]
params.asd.diameter_mm = 0.0;   % Septal defect diameter [mm]
params.asd.Cd          = 0.70;  % Orifice discharge coefficient [-]
params.asd.rho_blood   = 1060;  % Blood density [kg/m^3]
params.asd.is_closed   = true;  % Closure flag [-]

params.R.asd = Inf;  % Nested ASD resistance mirror [mmHg*s/mL]
