...
% 2b. Pulmonary flow Qp
rows = add_row(rows, 'Qp_Lmin', field_or_nan(metrics, 'Qp_Lmin'), 'L/min', ...
    field_or_nan(src, 'Qp_Lmin'), source_field(scenario, 'Qp_Lmin'), ...
    'Pulmonary flow; Qp = Qs + Q_ASD');
