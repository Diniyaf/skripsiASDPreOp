...
eR_pul = -0.70;
eC     = +1.00;
eL     = -1.00;   % Inertance scaling adopted from Lundquist mechanical similarity.
eRv_op = -0.50;   % Zhang 2019 Table 1: valve opening coefficient exponent.
...
params.scaling.zhang_exponents = struct( ...
    'HR', eHR, 'E_lv', eE_lv, 'E_rv', eE_rv, 'V0', eV0, ...
    'R_sys', eR_sys, 'R_pul', eR_pul, 'C', eC, 'L', eL, ...
    'Rvalve_open', eRv_op);
end
